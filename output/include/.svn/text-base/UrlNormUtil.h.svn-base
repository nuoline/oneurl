...
* @date 2012-5-20
* @description URL归一化通用数据结构以及函数头文件
* @references Chrome/gurl
*/
#ifndef PANGU_URL_CANON_UTIL_H_
#define PANGU_URL_CANON_UTIL_H_
...
//
// Implementation is in UrlNormIcu.cc.
...
void ConvertUTF16ToQueryEncoding(const char16* input,const Component& query,CharsetConverter* converter,CanonOutput* output);
