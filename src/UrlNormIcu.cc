...
#include "UrlNormUtil.h"  // for _itoa_s
#include "string16.h"
...
void ICUCharsetConverter::ConvertFromUTF16(const char16* input,int input_len,CanonOutput* output) {
...
int Gbk2Utf8(char *target,int32_t targetCapacity,const char *source,int32_t sourceLength) {
     UErrorCode ErrorCode = U_ZERO_ERROR;
     int ret = ucnv_convert("UTF-8","gb18030",target,targetCapacity,source,sourceLength,&ErrorCode);
     return ret;
}
